	...
	if(timenow<=m4){
		...
		if(timenow>=tet[i].m1){//m1-m4
			...
			if(timenow>=m2){//almostover
				...
				txtdaystext="Cung";txthourstext="Chúc";txtminstext="Tân";txtsecstext="Xuân";
			}
		}
		else{//almostcoming
		}
		...
		$('meta[name="description"]').attr("content", "Còn bao nhiêu ngày nữa đến Tết Nguyên Đán "+txttet+"?");
		$('meta[property="og\\:title"]').attr("content", txttitle);
		$('meta[property="og\\:description"]').attr("content", "Còn bao nhiêu ngày nữa đến Tết Nguyên Đán "+txttet+"?");
		$('meta[property="og\\:image"]').attr("content", "https://www.saptet.com/Tulips.jpg");
		break;
	}
}},1000);}
setClock();
