...
public class ListProduct extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (null == session.getAttribute("email")) {
			...
			String author = (request.getParameter("author") == null || request.getParameter("author") == "") ? "" : request.getParameter("author");
			String title = (request.getParameter("title") == null || request.getParameter("title") == "") ? "" : request.getParameter("title");
			String priceFrom = (request.getParameter("priceFrom") == null || request.getParameter("priceFrom") == "") ? "" : request.getParameter("priceFrom");
			String priceTo = (request.getParameter("priceTo") == null || request.getParameter("priceTo") == "") ? "" : request.getParameter("priceTo");
			String idCategory = (request.getParameter("idCategory") == null || request.getParameter("idCategory") == "") ? "-1" : request.getParameter("idCategory");

			
			if (name != "" || author != "" || title != "" || priceFrom != "" || priceTo != "" || idCategory != "-1") {
