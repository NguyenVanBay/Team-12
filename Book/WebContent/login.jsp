	...
	<div class="container" style="margin: 50px;">
		<div class="form">
			...
			<form action="/Book/dang-nhap-dang-ki" method="post">
				...
				<input type="hidden" name="page" value="<%= request.getParameter("checkout") %>" />
				<div class="list-form">
					<label for="uname"><b>Email</b></label> <input type="text" placeholder="Nhập email" value="" onfocusout="checkParamLogin()"
					 id="emaillg" class="cje" name="email" required>
					<div id="er-email-lg">
						<p id="t-email-lg" class="er-red"></p>
					</div>

					<label for="uname"><b>Mật khẩu</b></label> <input type="password" placeholder="Nhập mật khẩu" value="" onfocusout="checkParamLogin()"
					 id="passwordlg" name="password" required>
		...
		<div class="form">
			...
			<form action="/Book/dang-nhap-dang-ki" method="post">
				...
				<div class="list-form">
					...
					<label for="uname"><b>Họ tên</b></label> <input type="text" placeholder="Nhập họ tên" onfocusout="checkParam()" id="rg-name"
					 name="name" required>
					<div id="er-name-rg">
						<p id="name-rg" class="er-red"></p>
					</div>

					<label for="uname"><b>Email</b></label> <input type="text" placeholder="Email" onfocusout="checkParam()" id="rg-email"
					 name="email" required>
					<div id="er-email-rg">
						<p id="email-rg" class="er-red"></p>
					</div>

					<label for="uname"><b>Password</b></label> <input type="password" id="rg-password" onfocusout="checkParam()"
					 placeholder="Password" name="password" required>
					<div id="er-password-rg">
						<p id="password-rg" class="er-red"></p>
					</div>

					<label for="uname"><b>Nhập lại password</b></label> <input type="password" id="rg-repassword" onfocusout="checkParam()"
					 placeholder="Nhập lại password" name="repassword" required>
					<div id="er-repassword-rg">
						<p id="repassword-rg" class="er-red"></p>
					</div>

					<label for="uname"><b>Số điện thoại</b></label> <input type="text" id="rg-phone" onfocusout="checkParam()"
					...
					<label for="uname"><b>Địa chỉ</b></label> <input type="text" id="rg-address" onfocusout="checkParam()" placeholder="Địa chỉ"
