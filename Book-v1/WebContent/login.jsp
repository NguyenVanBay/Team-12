		...
		<div class="form">
			...
			<form action="/Book/dang-nhap-dang-ki" method="post">
				...
				<div class="list-form">
					...
					<label for="uname"><b>Họ tên</b></label> <input type="text"
					...
					<label for="uname"><b>Password</b></label> <input type="password"
						id="rg-password" onfocusout="checkParam()" placeholder="Password"
					...
					<label for="uname"><b>Địa chỉ</b></label> <input type="text"
						id="rg-address" onfocusout="checkParam()" placeholder="Địa chỉ"
